...
var _Promise = (function() {
  function _Promise(resolver) {
    if (typeof resolver !== "function") {
      //resolver必须是函数
      throw new TypeError(
        "_Promise resolver " + resolver + " is not a function"
      );
    }
    if (!(this instanceof _Promise)) return new _Promise(resolver);
  ...
  //获取当前Promise传递的值
  _Promise.prototype.valueOf = function() {
    return this.data;
  };
  ...
  _Promise.prototype.spread = function(fn, onRejected) {
    return this.then(function(values) {
      return fn.apply(null, values);
    }, onRejected);
  };

  _Promise.prototype.inject = function(fn, onRejected) {
  ...
  _Promise.prototype.delay = function(duration) {
    return this.then(
      function(value) {
  ...
  _Promise.fcall = function(fn) {
    // 虽然fn可以接收到上一层then里传来的参数，但是其实是undefined，所以跟没有是一样的，因为resolve没参数啊
    return _Promise.resolve().then(fn);
  };

  _Promise.done = _Promise.stop = function() {
...
const aa = new _Promise((resolve, reject) => {
